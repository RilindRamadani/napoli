...
async function fetchData() {
    try {
        const response = await fetch('http://localhost:3001/products?category=KITCHEN');
...
export default function Kitchen() {
    ...
    return (
        <div >
            <TableDisplay locationName="Kitchen" headerBackgroundColor={COLORS.KitchenHeaderBackground} textColor={COLORS.KitchenHeaderColor} products={products} />
        </div>
    );
}
